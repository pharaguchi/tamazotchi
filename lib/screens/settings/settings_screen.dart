      ...
      children: [
        ...
        Row(
          ...
          children: [ 
            ElevatedButton.icon(
              onPressed: () {
                _carouselController.previousPage(duration: Duration(milliseconds: 300), curve: Curves.linear); // Move to the next page
              },
            ...
            ElevatedButton.icon(
              onPressed: () async {
                ...
                await _databaseService.updateTamagotchi(tamagotchiNames[_currentIndex]);
            ...
            ElevatedButton.icon(
              onPressed: () {
                _carouselController.nextPage(duration: Duration(milliseconds: 300), curve: Curves.linear); // Move to the next page
              },
